...
const LoginPage = () => {
  ...
  // التحقق مما إذا كان هناك إيميل محفوظ مسبقاً عند فتح الصفحة
  useEffect(() => {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      // إذا تم الدخول بنجاح، نتحقق من خيار "تذكرني"
      if (rememberMe) {
        localStorage.setItem('unihome_saved_email', email); // حفظ الإيميل
      } else {
        localStorage.removeItem('unihome_saved_email'); // مسح الإيميل إذا لم يحدد الخيار
      }
