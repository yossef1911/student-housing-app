...
// المكون الرئيسي لصفحة "حجوزاتي" لعرض الغرف التي قام الطالب بحجزها
const MyBookings = () => {
  ...
  // التحقق من الجلسة وجلب حجوزات الطالب من قاعدة البيانات
  useEffect(() => {
  ...
  // تحديد الألوان المناسبة بناءً على حالة الحجز أو الدفع
