...
// المكون الرئيسي لصفحة إنشاء الحساب وتسجيل الطلاب الجدد
const Signup = () => {
  ...
  // تصفية حقل الاسم للسماح بالحروف الإنجليزية فقط
  const handleNameChange = (e) => {
    const englishOnlyName = e.target.value.replace(/[^a-zA-Z\s]/g, '');
    setName(englishOnlyName);
  };

  // تصفية حقل الرقم الجامعي للسماح بالأرقام فقط ومنع البداية بصفر
  ...
  // تصفية حقل البريد الإلكتروني للسماح بالصيغة الصحيحة فقط
  ...
  // معالجة عملية إنشاء الحساب مع التحقق من المدخلات (Validation)
